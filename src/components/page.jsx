...
<div class="row">
  <div class="col-sm-4 bottom"><img src={Retro}  alt="retro" /><div className="btm-text"><h2>01</h2><h3><a href="#" className="btm-link">Reviving Retro PCs</a></h3><p>What happens when old PCs are given modern updates?</p></div></div>
  <div class="col-sm-4 bottom"><img src={Laptop} alt="laptop" /><div className="btm-text"><h2>02</h2><h3><a href="#" className="btm-link">Top 10 Laptops of 2022</a></h3><p>Our top picks for various needs and budgets.</p></div></div>
  <div class="col-sm-4 bottom"><img src={Gaming} alt="gaming" /><div className="btm-text"><h2>03</h2><h3><a href="#" className="btm-link">The Growth of Gaming</a></h3><p>How the pandemic has sparked fresh opportunities.</p></div></div>
</div>
